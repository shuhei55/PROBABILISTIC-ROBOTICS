...
def plot(data):
    ...
    ball_img = drawer.draw_point(ekf.x,ekf.y, c='b')
    ball_img = drawer.draw_circle(ekf.x,ekf.y,np.sqrt(ekf.Pxy[0][0]),np.sqrt(ekf.Pxy[1][1]),c='g')
